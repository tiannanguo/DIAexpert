...
# in_file1 = "../../12_pc39_2nd_os/PyProphet/3R_reference_samples_b.txt"
# in_file2 = "pcp100_4R_pcv_spsvtr_lib_allFrag_pcp.chrom.mzML.gz"
# in_file3 = "../../14_pcp39_allFragLib/7R_pcv_spsvtr_lib_allFrag_pcp.csv" # "AQUA374_ms1.csv"  #AQUA374_step4.csv
# out_file = "pcp100_4R_pcv_spsvtr_lib_allFrag_pcp.chrom.txt.gz"
# id_mapping_file = "../../pcp39sw210.txt"
                        ...
                        for binary_array_data in binary_array_data_list.iter():
                            ...
                            for binary in binary_array_data.iter(binary_tag):
                                if if_rt_list == 1:
                                    ...
                                    #decode rt and int
                                    if rt_list is not None and i_list is not None:
                                        ...
                                        writer.writerow((transition_name, '', '',
                                             library_data[transition_name]['transition_group_id'],
                                             best_rt[library_data[transition_name]['transition_group_id']],
                                             best_sample[library_data[transition_name]['transition_group_id']],
                                             best_score[library_data[transition_name]['transition_group_id']],
                                             library_data[transition_name]['protein'],
                                             library_data[transition_name]['rt'],
                                             library_data[transition_name]['PrecursorMz'],
                                             library_data[transition_name]['ProductMz'],
                                             library_data[transition_name]['LibraryIntensity']))
